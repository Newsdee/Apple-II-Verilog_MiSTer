#!/bin/sh
# ============================================================================
# Level 2 MiSTer integration-test core - full Quartus compile.
#
# Usage (from anywhere):
#     sh unit_tests/level_2/mister/build.sh
#
...
#     unit_tests\level_2\mister\output_files\level2.rbf
#
...
# ============================================================================
cd "$(dirname "$0")/../../.." || exit 1
mkdir -p unit_tests/level_2/mister/rtl/roms unit_tests/level_2/mister/rtl/pll
cp -r -u sys/. unit_tests/level_2/mister/sys/
cp -u jtag.cdf unit_tests/level_2/mister/
cp -u rtl/pll.qip rtl/pll.v unit_tests/level_2/mister/rtl/
cp -r -u rtl/pll/. unit_tests/level_2/mister/rtl/pll/
cp -r -u rtl/roms/. unit_tests/level_2/mister/rtl/roms/
